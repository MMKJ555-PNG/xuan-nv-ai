...
paths:
  /v1/chat/completions:
    post:
      ...
      x-apifox-folder: 聊天(Chat)
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3868318/apis/api-287782723-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
...
paths:
  /v1/chat/completions:
    post:
      ...
      x-apifox-folder: 聊天(Chat)
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3868318/apis/api-139453850-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
...
paths:
  /v1/chat/completions:
    post:
      ...
      x-apifox-folder: 聊天(Chat)
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3868318/apis/api-287782833-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
...
paths:
  /v1/chat/completions:
    post:
      ...
      x-apifox-folder: 聊天(Chat)
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3868318/apis/api-287782839-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
